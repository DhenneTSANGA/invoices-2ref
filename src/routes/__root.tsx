...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plateforme d'automatisation du cabinet 2R Expertise Fiscale." },
      { name: "author", content: "2R Expertise Fiscale" },
      { property: "og:title", content: "2R Expertise Fiscale — Automatisation cabinet fiscal" },
    ...
    links: [
      ...
      { rel: "icon", href: "/log1.png", type: "image/png", sizes: "any" },
      { rel: "apple-touch-icon", href: "/log1.png" },
    ],
  }),
